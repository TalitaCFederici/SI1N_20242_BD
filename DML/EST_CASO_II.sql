DROP SCHEMA exercicio2_dml;

CREATE SCHEMA exercicio2_dml;
...
CREATE TABLE IF NOT EXISTS AEROPORTOS (
    ...
    LOCAL_AEROPORTO VARCHAR(100) NOT NULL,
...
CREATE TABLE IF NOT EXISTS VOOS (
    ...
    STATUS_VOO ENUM('agendado', 'cancelado', 'realizado'),
    ID_AERONAVES INT NOT NULL,
    CONSTRAINT FK_ORIGEM FOREIGN KEY (AEROPORTO_ORIGEM) REFERENCES AEROPORTOS(AERO_COD),
...
CREATE TABLE IF NOT EXISTS EQUIPES (
    ...
    PRIMARY KEY(ID_FUNCIONARIO, FNCO_VOOS),
    CONSTRAINT FNC_FK_FUNCIONARIOS FOREIGN KEY (ID_FUNCIONARIO) REFERENCES FUNCIONARIOS(ID_FUNC),
...
CREATE TABLE IF NOT EXISTS RESERVAS (
    ...
    DATA_RESERVA DATE,
    CONSTRAINT FK_R_PASSAGEIROS FOREIGN KEY(PASSAGEIRO_ID) REFERENCES PASSAGEIROS(ID_PASS),
